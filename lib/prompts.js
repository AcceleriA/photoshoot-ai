...
CRITICAL — Body and face preservation: The subject's face shape, jawline width, cheek fullness, and overall facial volume must exactly match the reference photo. Do NOT slim the face, narrow the jaw, or reduce cheek volume. The subject's body type, weight, and proportions must remain strictly identical to the reference. No slimming, no elongation, no idealization whatsoever.
