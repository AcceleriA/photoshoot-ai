...
// Shared technical base for all prompts — identity + grain + hands
const TECH_BASE = `Use the attached photo as the SOLE identity reference. The face, facial structure, bone structure, proportions, and all recognizable characteristics must remain strictly identical to the source photo. No morphological modification. No idealization or artificial beautification.

Preserve exactly: nose shape and width, jaw and chin structure, eye shape and spacing, eyebrow thickness and arch, lip shape and fullness, ear shape and size, hairline and hair texture, facial hair pattern and density. The person's actual body type, weight, and proportions must be preserved. No slimming, no idealization.

Strictly preserve the grain, texture, and noise level of the input photo. Do not smooth the skin. Do not add artificial sharpness. Maintain a natural photographic rendering, slightly grainy, consistent with a full-frame sensor.

Hands must have exactly 5 fingers each with natural proportions and realistic anatomy. If hands are not essential to the scene, keep them hidden or partially visible. Never show hands with incorrect finger count or unnatural bending.`;
...
The face, proportions, features, age, and base expression must remain strictly identical to the source photo. No morphological modification. No idealization. No excessive stylistic interpretation.
...
Hands must have exactly 5 fingers each. If hands appear, they must have natural proportions. Prefer compositions where hands are hidden or barely visible.
...
The face, proportions, and features must remain strictly identical to the source photo. No morphological modification. No excessive idealization.
...
Hands must have exactly 5 fingers each with natural proportions. Prefer compositions where hands are not visible.
